...
document.querySelector("#form").addEventListener("submit", function (e) {
  ...
  const idPopup = document.getElementById("w-__popup_default__");
  ...
  fetch(GOOGLE_SCRIPT_URL_THAM_DU, {
    ...
    submitBtn.textContent = "GỬI LỜI NHẮN & XÁC NHẬN";
    if (idPopup) idPopup.style.setProperty("display", "block", "important");
...
function closePopup() {
  const idPopup = document.getElementById("w-__popup_default__");
  if (idPopup) idPopup.style.setProperty("display", "none", "important");
}
